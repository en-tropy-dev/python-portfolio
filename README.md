...
Note: in the beginning of the code client id is being extracted form the txt file. This file is empty in the repository,
so the program will return 'there is an issue with file client_id.txt'.
...
Note: recipe dataset in folder was already sorted out by me for convenience. The original file was too big to upload.
If you are interested how file was sorted, you can check sorting_recipes.py.
